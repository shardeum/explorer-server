...
const tempHeader = [
  ...
  },
  {
    ...
    render: (_: unknown, item: any) => (
      <Chip title={showTxMethod(item)} color="success" size="medium" />
    ),
  },
  {
    key: "cycle",
      ...
      tHeader = [
        ...
        },
        {
          ...
          render: (val: unknown, item: any) =>
            calculateTokenValue(item, val as TransactionType),
        },
        {
          key: "transactionFee",
          value: "Txn Fee",
    ...
    if (txType === TransactionSearchType.ERC_1155) {
      tHeader = [
        ...
        },
        {
          ...
          value: "Token ID",
          render: (val: unknown, item: any) =>
            calculateTokenValue(item, val as TransactionType, true),
        },
        {
          key: "tokenType",
          value: "Value",
